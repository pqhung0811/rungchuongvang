...
#include "../../../RCVproject/client/core/clientmanager.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSClientManagerENDCLASS_t qt_meta_stringdata_CLASSClientManagerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(14, 5),  // "login"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 8),  // "username"
        QT_MOC_LITERAL(30, 8),  // "password"
        QT_MOC_LITERAL(39, 8),  // "viewrank"
        QT_MOC_LITERAL(48, 10),  // "createroom"
        QT_MOC_LITERAL(59, 8),  // "roomname"
        QT_MOC_LITERAL(68, 8),  // "findroom"
        QT_MOC_LITERAL(77, 14),  // "hanldeResponse"
        QT_MOC_LITERAL(92, 7)   // "jsonDoc"
    },
    "ClientManager",
    "login",
    "",
...
void ClientManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->viewrank(); break;
        case 2: _t->createroom((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 3: _t->findroom(); break;
        case 4: _t->hanldeResponse((*reinterpret_cast< std::add_pointer_t<QJsonDocument>>(_a[1]))); break;
        default: ;
        }
    }
}
