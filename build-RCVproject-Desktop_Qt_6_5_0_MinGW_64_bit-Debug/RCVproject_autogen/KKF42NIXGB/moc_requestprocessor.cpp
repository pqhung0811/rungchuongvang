...
#include "../../../RCVproject/server/core/processor/requestprocessor.h"
...
static constexpr auto qt_meta_stringdata_CLASSRequestProcessorENDCLASS = QtMocHelpers::stringData(
    "RequestProcessor"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSRequestProcessorENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSRequestProcessorENDCLASS_t qt_meta_stringdata_CLASSRequestProcessorENDCLASS = {
    {
        QT_MOC_LITERAL(0, 16)   // "RequestProcessor"
    },
    "RequestProcessor"
};
