...
Q_CONSTINIT static const qt_meta_stringdata_CLASSUserAPIENDCLASS_t qt_meta_stringdata_CLASSUserAPIENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(188, 22)   // "getAllUsersOrderByRank"
    },
    "UserAPI",
    "getAllUsers",
    "QList<User*>",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSUserAPIENDCLASS[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       4,    2,   69,    3, 0x0a,    2 /* Public */,
       8,    2,   74,    3, 0x0a,    5 /* Public */,
       9,    0,   79,    3, 0x0a,    8 /* Public */,
      10,    1,   80,    3, 0x0a,    9 /* Public */,
      12,    1,   83,    3, 0x0a,   11 /* Public */,
      13,    3,   86,    3, 0x0a,   13 /* Public */,
      16,    2,   93,    3, 0x0a,   17 /* Public */,
      18,    0,   98,    3, 0x0a,   20 /* Public */,
...
void UserAPI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 8: { QList<User*> _r = _t->getAllUsersOrderByRank();
            if (_a[0]) *reinterpret_cast< QList<User*>*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
